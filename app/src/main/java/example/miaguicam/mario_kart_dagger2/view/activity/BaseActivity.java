...
import example.miaguicam.mario_kart_dagger2.view.presenter.Presenter;
...
public abstract class BaseActivity  extends AppCompatActivity implements Presenter.View{
  ...
  /*  private void onPrepareSupportActionBar() {
     ...
     * Override this method to configure your presenter with extra example.miaguicam.mario_kart_dagger2.data if needed.
     */
